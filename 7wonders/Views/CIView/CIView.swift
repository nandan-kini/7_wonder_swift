...
struct CIView: View {
    @StateObject var cIViewModel = CIViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        VStack {
            ZStack(alignment: .center) {
                Image("img_image2_836x411")
                    .resizable()
                    ...
                    VStack {
                        HStack {
                            ...
                            HStack {
                                VStack(alignment: .leading, spacing: 0) {
                                    Text(StringConstants.kLblChichenItza)
                                        .font(FontScheme
                                        ...
                                        .frame(width: getRelativeWidth(103.0),
                                               ...
                                               alignment: .topLeading)
                                    Text(StringConstants.kLblYucatanMexico)
                                        .font(FontScheme
                            ...
                            .frame(width: getRelativeWidth(233.0), height: getRelativeHeight(36.0),
                                   alignment: .center)
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            Text(StringConstants.kLblDescription)
                                ...
                                .padding(.trailing)
                            Text(StringConstants.kMsgChichNItzW)
                ...
                .frame(width: getRelativeWidth(380.0), height: getRelativeHeight(702.0),
                       alignment: .center)
