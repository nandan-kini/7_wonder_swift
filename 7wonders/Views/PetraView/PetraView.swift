...
struct PetraView: View {
    @StateObject var petraViewModel = PetraViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        VStack {
            ZStack(alignment: .center) {
                Image("img_image3_823x411")
                    .resizable()
                ...
                VStack(alignment: .trailing, spacing: 0) {
                    ...
                    VStack {
                        HStack {
                            ...
                            HStack {
                                VStack(alignment: .leading, spacing: 0) {
                                    Text(StringConstants.kLblPetra)
                                        .font(FontScheme
                                        ...
                                        .frame(width: getRelativeWidth(45.0),
                                               ...
                                               alignment: .topLeading)
                                        .padding(.trailing)
                                    Text(StringConstants.kMsgKingdomOfJord)
                                        .font(FontScheme
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            Text(StringConstants.kLblDescription)
                                ...
                                .padding(.trailing)
                            Text(StringConstants.kMsgTheCityIsFam)
                            ...
                            .frame(width: getRelativeWidth(331.0), height: getRelativeHeight(79.0),
                                   alignment: .center)
                    ...
                    .padding(.top, getRelativeHeight(249.0))
                    .padding(.leading, getRelativeWidth(21.0))
                    .padding(.trailing, getRelativeWidth(5.0))
                }
                .frame(width: getRelativeWidth(380.0), height: getRelativeHeight(706.0),
                       alignment: .center)
...
struct PetraView_Previews: PreviewProvider {
